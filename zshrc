...
export ZSH="/home/zeroday/.oh-my-zsh"
...
alias lsd='logo-ls'
alias la='logo-ls -a'
alias lt='logo-ls -ltrh'
alias cat='bat'
alias us='ps -e -o pid,cmd,%cpu,%mem --sort=-%mem | head -n 6'
# Exports
export GEM_HOME="$(ruby -e 'puts Gem.user_dir')"
...
export PROMPT="
%F{magenta}%n@%m%f%F{green}%f%F{white} on %f%F{cyan}%~
%(?.%F{blue}»%f.%F{red}»%f) "
...
source /home/zeroday/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
